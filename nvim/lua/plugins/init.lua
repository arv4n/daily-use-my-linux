...
{
  "github/copilot.vim",
  event = "InsertEnter",  -- Plugin hanya diaktifkan saat memasuki mode insert
  config = function()
...

{
  ...
  dependencies = {
    ...
    { 'hrsh7th/nvim-cmp', lazy = false },  -- Menambahkan nvim-cmp
    { 'hrsh7th/cmp-buffer', lazy = false }, -- Menambahkan plugin buffer untuk autocomplete
  },
...
cmd = {
  ...
  "DBUISaveQuery", -- ini yang kurang tot!
},
  ...
  config = function()
    -- Integrasi dengan nvim-cmp untuk SQL
