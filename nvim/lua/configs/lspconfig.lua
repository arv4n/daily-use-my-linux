...
local servers = {
  "rust_analyzer", "fortls", "ts_ls", "jdtls", "html", "tailwindcss", "clangd",
  "ruff", "jsonls", "yamlls", "vimls", "eslint", "lua_ls", "sqlls", "taplo",
  "terraformls", "elixirls", "ocamlls", "phpactor", "sourcery", "solargraph",
  "svelte", "vuels", "clojure_lsp", "groovyls", "bashls", "cssls",
  "intelephense", "r_language_server", "asm_lsp"}


-- Capabilities with snippet support
local capabilities = vim.lsp.protocol.make_client_capabilities()
capabilities = require("cmp_nvim_lsp").default_capabilities(capabilities)
capabilities.textDocument.completion.completionItem.snippetSupport = true

-- Tambahkan fitur tambahan untuk capabilities
capabilities.textDocument.formatting = {
  dynamicRegistration = true,
}
capabilities.textDocument.highlight = {
  dynamicRegistration = true,
}
...
lspconfig.sqls.setup({
  cmd = { "sqls" },
  filetypes = { "sql" },
  root_dir = lspconfig.util.root_pattern(".git", "sqls.yml", "*.sql"),
  settings = {
    sqls = {
...
lspconfig.sourcery.setup {
  ...
  init_options = {
    token = "user_dfntfFa9n9d_VdOxbgs_vb_YG539YluNfxNxRZXJPyFpMY2EdzkjXWzXIWA",
  },
}
